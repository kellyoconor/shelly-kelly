...
## Up Next
- [ ] **Google Calendar ICS feed** — read-only calendar access via secret iCal URL. Kelly's considering it but not ready yet. Would unlock schedule-aware morning briefings + proactive reminders
